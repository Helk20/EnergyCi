...
```
$ docker image tag feoptimisationenergie helk1111/feoptimisationenergie/feoptimisationenergie
$ docker push helk1111/feoptimisationenergie/feoptimisationenergie
```
...
```
$ kubectl get svc feoptimisationenergie -n MyK8
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n MyK8
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n MyK8
```
